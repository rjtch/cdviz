    ...
    ">
      ...
      <div class="grid gap-8 md:grid-cols-2 md:grid-rows-2">
        <div class="flex flex-row items-start gap-4 bg-secondary/10 p-6 rounded-xl">
          ...
          <div class="flex-1">
            <div class="text-xl font-semibold mb-2">Event Collection</div>
        ...
        <div class="flex flex-row items-start gap-4 bg-secondary/10 p-6 rounded-xl">
          ...
          <div class="flex-1">
            <div class="text-xl font-semibold mb-2">Store Events</div>
            <p class="text-base leading-relaxed mb-4">
              <!-- Pull or receive events from multiple sources and convert them to standardized cdevents. -->
        ...
        <div class="flex flex-row items-start gap-4 bg-secondary/10 p-6 rounded-xl">
          ...
          <div class="flex-1">
            <div class="text-xl font-semibold mb-2">Event Monitoring</div>
            <p class="text-base leading-relaxed mb-4">
        ...
        <div class="flex flex-row items-start gap-4 bg-secondary/10 p-6 rounded-xl">
          ...
          <div class="flex-1">
            <div class="text-xl font-semibold mb-2">Event Reaction</div>
            <p class="text-base leading-relaxed mb-4">
